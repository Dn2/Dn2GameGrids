...
public:	
	...
	virtual void BuildDebugProcMesh(UProceduralMeshComponent* ProcMeshComp, bool bDrawGrid, bool bDrawBlockedAsWalls, FGameplayTagContainer WallFilters, float WallHeight = 0.0f, float WallWidth = 0.0f) override;
